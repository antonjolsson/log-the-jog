...
public class Egm96Location {
	...
	public Egm96Location() {
		init(0.0, 0.0, true);		
	}

	public Egm96Location(double lat, double lng) {
		init(lat, lng, true);		
	}

	public Egm96Location(double lat, double lng, boolean lenient) {
	...
	public boolean equals(Object o) {
		...
		if(!(o instanceof Egm96Location)) {
			return false;
		}

		Egm96Location other = (Egm96Location) o;
	...
	public Egm96Location floor(double precision) {
		...
		return new Egm96Location(latFloor, lngFloor);
	}
}